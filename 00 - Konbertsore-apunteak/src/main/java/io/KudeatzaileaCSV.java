...
public class KudeatzaileaCSV {
    ...
    public static void menua() {
        ...
        do {
            ...
            System.out.println(Gehigarriak.Berdea + "1. CSV fitxategia sortu.");
            System.out.println("2. CSV fitxategiak bistaratu.");
            System.out.println("3. CSV fitxategia irakurri.");
            System.out.println("4. CSV fitxategian datuak gehitu");
            System.out.println("5. CSV fitxategia eguneratu.");
            System.out.println("6. CSV fitxategia ezabatu.");
            System.out.println("7. CSV fitxategia TXT formatura bihurtu.");
            System.out.println("8. CSV fitxategia XML formatura bihurtu.");
            System.out.println("9. CSV fitxategia JSON formatura bihurtu.");
            System.out.println(Gehigarriak.Urdina + "10. Irten");
            System.out.println(Gehigarriak.Cyan + "================================");
